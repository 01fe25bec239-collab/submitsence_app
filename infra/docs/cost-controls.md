...
- Dev uses one NAT gateway, single-node Redis, small RDS, zero always-on workers, and short logs.
...
Largest baseline costs are NAT gateways, production Multi-AZ RDS, Redis replica, WAF rules, GuardDuty,
and VPC endpoints. Do not remove encryption, private networking, backups, WAF, or security monitoring
